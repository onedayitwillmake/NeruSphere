...
void ParticleSystem::add( ci::Vec2f pos, ci::Vec2f velocity, ci::ColorA color, ci::Rectf srcCoords, ci::Rectf destRect ) {
	...
	// Vertices
	verts.push_back( destRect.getX1() ); verts.push_back( destRect.getY2() ); verts.push_back( 1 );
	verts.push_back( destRect.getX2() ); verts.push_back( destRect.getY2() ); verts.push_back( 1 );
	verts.push_back( destRect.getX2() ); verts.push_back( destRect.getY1() ); verts.push_back( 1 );
	verts.push_back( destRect.getX1() ); verts.push_back( destRect.getY2() ); verts.push_back( 1 );
	verts.push_back( destRect.getX2() ); verts.push_back( destRect.getY1() ); verts.push_back( 1 );
	verts.push_back( destRect.getX1() ); verts.push_back( destRect.getY1() ); verts.push_back( 1 );
...
void ParticleSystem::update() {
	...
	float zspeed = fabs( Constants::Instances::PERLIN_NOISE()->noise( (verts[0] + ci::app::getElapsedFrames()) * 0.001 ) )  * 30 + 2;
